...
par(mfrow=c(1,2))
hist(frequencies_no_gps, xlab = "Ermittelte Frequenzen", ylab="Häufigkeit", main = "Histogramm ohne GPS")
hist(frequencies_gps, xlab = "Ermittelte Frequenzen", ylab="Häufigkeit", main = "Histogramm mit GPS")
